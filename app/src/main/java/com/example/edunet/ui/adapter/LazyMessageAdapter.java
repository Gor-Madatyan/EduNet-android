...
public class LazyMessageAdapter extends MessageAdapter {
    private final Paginator<Message> paginator;

    public LazyMessageAdapter(Paginator<Message> paginator, AccountService accountService, MessagingService messagingService) {
