...
public class CommunityCreateWorker extends ListenableWorker {
    ...
    public ListenableFuture<Result> startWork() {
        CommunityModifyRequest request = getCommunityCreateRequestFromData();
    ...
    public static Data getDataFromCommunityCreateRequest(CommunityModifyRequest request) {
    ...
    private CommunityModifyRequest getCommunityCreateRequestFromData() {
